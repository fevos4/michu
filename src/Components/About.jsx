        ...
        <div className="w-full flex flex-col justify-between px-6 md:p-24" id="about">
            <div className="grid md:grid-cols-2 gap-4 md:gap-16"> 
                <div className="order-2 md:order-1 justify-center hidden md:flex">
                    <img src="/assets/about.png" alt="Picture" className="h-60 md:h-80 md:ml-20 object-contain" />
                </div>
                <div className="flex flex-col justify-center md:items-start w-full px-2 py-8 order-1 md:order-2">
                    <p className="font-bold text-2xl text-left">Why Us?</p>
                    <p className="py-3 md:mb-5 font-regi text-left">
                    ...
                    <p className="font-bold text-2xl text-left">Our Offerings:</p>
